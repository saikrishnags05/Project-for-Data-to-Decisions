...
We then use ANOVA to get the relationship between many of the variables.  This might not be valid since the distribution is not normal.
...
###Find missing values
```{r}
is.na(HFS.Ethnic_identity.cleaned)
```
