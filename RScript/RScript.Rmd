...
```{r filter}
data <- as_tibble(read.csv("/Users/ccrowe/github/isqa8600_ChadCrowe/programs/data/HFS Service Data.csv"))
...
Since we've created some insightful plots, it's worth getting a feeling of how strong the relationship is between no-show percentage and the other variables we've investigated.
